...
import de.tu_bs.cs.isf.cbc.tool.patterns.EventSequenceConditionPattern;
import de.tu_bs.cs.isf.cbc.tool.patterns.EventSequenceConditionsPattern;
...
public class CbCFeatureProvider extends DefaultFeatureProviderWithPatterns {
	...
	public CbCFeatureProvider(IDiagramTypeProvider dtp) {
		...
		addPattern(new EventSequenceConditionsPattern());
		addPattern(new EventSequenceConditionPattern());
	...
	public ICustomFeature[] getCustomFeatures(ICustomContext context) {
		return new ICustomFeature[] { new ExtractMethodStubsFeature(this), // !
				...
				// Event Sequences
				new EventSequenceContextUI(this) };
	}
}
